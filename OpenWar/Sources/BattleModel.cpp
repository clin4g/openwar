...
{
	glm::vec3 position = glm::vec3(casualty.position, _simulationState->smoothTerrainModel->GetHeight(casualty.position));
...
void BattleModel::AddShootingMarker(const Shooting& shooting)
{
	...
	{
		glm::vec3 p1 = glm::vec3(projectile.position1, _simulationState->smoothTerrainModel->GetHeight(projectile.position1));
		glm::vec3 p2 = glm::vec3(projectile.position2, _simulationState->smoothTerrainModel->GetHeight(projectile.position2));
